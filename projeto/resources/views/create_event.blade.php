            ...
            <div class="mb-1 w-100 d-flex">
                <div class="col-6 pe-4">
                    ...
                    <div id="container-input-init_date">
                        <input id="input-init_date" type="date" name="init_date" class="form-control  rounded-pill" required>
                    </div>
                </div>
                <div class="col-6 ps-4">
                    <label for="input-end_date" class="form-label">Data de encerramento </label>
                    <div id="container-input-end_date">
                        <input id="input-end_date" type="date" name="end_date" class="form-control  rounded-pill" required>
                    </div>
                </div>
            </div>
            <div class="mb-1 w-100">
                ...
                <div id="container-input-max_participants">
                    <input id="input-max_participants" type="number" name="max_participants" class="form-control  rounded-pill" required>
                </div>
            </div>
            <div class="mb-1 w-100">
                <label for="input-entry_price" class="form-label">Valor da entrada </label>
                <div id="container-input-entry_price">
                    <input id="input-entry_price" type="number" name="entry_price" class="form-control  rounded-pill" required>
                </div>
            </div>
            <div class="mb-1 w-100">
